...
const (
	MYSQL_TYPE_DECIMAL     uint8 = 0   // 浮点型
	MYSQL_TYPE_TINY        uint8 = 1   // tiny int
	MYSQL_TYPE_SHORT       uint8 = 2   // short
	MYSQL_TYPE_LONG        uint8 = 3   // long
	MYSQL_TYPE_FLOAT       uint8 = 4   // float32
	MYSQL_TYPE_DOUBLE      uint8 = 5   // double
	MYSQL_TYPE_NULL        uint8 = 6   // NULL
	MYSQL_TYPE_TIMESTAMP   uint8 = 7   // 时间戳
	MYSQL_TYPE_LONGLONG    uint8 = 8   // long long
	MYSQL_TYPE_INT24       uint8 = 9   // int24
	MYSQL_TYPE_DATE        uint8 = 10  // date
	MYSQL_TYPE_TIME        uint8 = 11  // time
	MYSQL_TYPE_DATETIME    uint8 = 12  // datetime
	MYSQL_TYPE_YEAR        uint8 = 13  // year
	MYSQL_TYPE_NEWDATE     uint8 = 14  // 时间
	MYSQL_TYPE_VARCHAR     uint8 = 15  // varchar
	MYSQL_TYPE_BIT         uint8 = 16  // bit
	MYSQL_TYPE_TIMESTAMP2  uint8 = 17  // timestamp
	MYSQL_TYPE_DATETIME2   uint8 = 18  // time
	MYSQL_TYPE_TIME2       uint8 = 19  // time
	MYSQL_TYPE_NEWDECIMAL  uint8 = 246 // 浮点型
